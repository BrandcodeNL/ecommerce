...
class RecentOrdersBlockService extends BaseBlockService
{
     ...
     */
    public function __construct($name, EngineInterface $templating, OrderManagerInterface $orderManager, CustomerManagerInterface $customerManager, TokenStorageInterface $tokenStorage, Pool $adminPool = null)
    {
